              ...
              <Popover>
                {({ open }) => (
                  <>
                    ...
                    >
                      <Popover.Panel className="hidden md:block absolute z-10 top-full inset-x-0 transform shadow-lg bg-stone-100">
        ...
        <div className=" w-full h-screen bg-white  text-left lg:text-left">
          ...
          <div className="px-4 py-8 lg:w-1/2 sm:px-8 ">
            ...
            <div className="flex  w-max  top-0 mb-6   py-2">
                <h1 className="flex ml-2 my-auto font-semibold uppercase mr-1 text-green-500 text-xl " >Ventures</h1> 
            ...
            <h1 className="tracking-tighter leading-[5.5rem] sm:leading-[6.5rem] font-bold text-black text-8xl sm:text-9xl mb-8">
              <span className="block xl:inline">Invest <span className="block">in the</span></span>{' '}
              <span className="block text-green-500 "><span className="text-white"></span>future.</span>
     
            </h1>
            <p className="mt-3 max-w-md font-regular  text-lg text-black opacity-80 sm:text-2xl md:mt-12 md:max-w-lg">
              Step into the world of <span className="text-green-500">angel investing</span> and support early-stage projects from a range of industries.
            </p>
            ...
            <div className=" sm:flex sm:justify-start  w-full lg:justify-start">
              <div className="absolute bottom-16">
                <a
                  href="#"
                  className="w-full flex items-center uppercase justify-center px-10 py-4 border border-transparent text-base font-medium  text-green-500 border-2 border-green-500 hover:bg-green-200 md:py-4 md:text-lg md:px-64"
                >
                  COMING SOON
                </a>
              </div>
