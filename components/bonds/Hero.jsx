        ...
        <div className=" w-full h-screen bg-black  text-left lg:text-left">
          ...
          <div className="px-4 py-8 lg:w-1/2 sm:px-8 ">
            ...
            <div className="flex  w-max  top-0 mb-6   py-2">
                <h1 className="flex ml-2 my-auto font-semibold uppercase mr-1 text-neutral-300 text-xl " >Bonds</h1> 
            ...
            <div className=" sm:flex sm:justify-start  w-full lg:justify-start">
              <div className="absolute bottom-16">
                <a
                  href="#"
                  className="w-full flex items-center uppercase justify-center px-10 py-4 border border-transparent text-base font-medium  text-cyan-400 border-2 border-cyan-500 hover:bg-cyan-800 md:py-4 md:text-lg md:px-64"
                >
                  Mint a bond
                </a>
              </div>
