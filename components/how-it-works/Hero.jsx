        ...
        <div className=" w-full h-max-content py-16 bg-white  text-left lg:text-left">
          ...
          <div className="px-4 py-8 lg:w-1/2 sm:px-8 ">
            ...
            <div className="flex  w-max  top-0 sm:mb-6   py-2">
                <h1 className="flex ml-2 my-auto font-semibold uppercase mr-1 text-green-600 text-xl " >NFT$</h1> 
                <div className="ml-2 mr-1 mt-2 ">
                
                </div>
                
            </div>
            <h1 className="tracking-tighter uppercase leading-[4.5rem] sm:leading-[7rem] font-bold text-black text-7xl sm:text-9xl mb-8">
              <span className="block xl:inline">NON-FUNGIBLE<span className="block ">FINANCIAL</span></span>{' '}
              <span className="block text-green-600 "><span className="text-white"></span>UTILITY</span>
