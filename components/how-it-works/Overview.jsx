...
const products = [
  ...
  {
    id: 4,
    name: 'BUY, SELL, TRADE YOUR INVESTMENTS',
    price: 'Nous democratises institutional exchange access meaning lower fees and higher security for your funds. ',
    rating: 5,
    reviewCount: 14,
    imageSrc: 'https://assets.website-files.com/62829b28e6300b34ff739f02/62ab4d5a0bfc7d3ce86024de_Group%20427322242.png',
    imageAlt: 'TODO',
    href: '#',
  },
...
export default function Example() {
  return (
    ...
    <div className="bg-white flex sm:flex-row flex-col ">
      ...
      <div className="max-w-7xl sm:w-1/3 flex mx-auto my-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
