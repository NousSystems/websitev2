  ...
  return (
    ...
    <div className="bg-white  ">
      ...
      >
       ...
       <div className=" relative w-full flex mx-auto  py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div className="text-left ">
          
          <p className="mt-1 ml-0  sm:ml-0 text-6xl font-extrabold  uppercase text-black  sm:tracking-tighter lg:text-8xl">
            Company.
          </p>
