...
export default function Example() {
  return (
    ...
    <div className="bg-black flex flex-col sm:flex-row ">
       <div className="max-w-7xl sm:w-1/4 flex sm:mx-auto   px-4  sm:px-6 lg:px-8">
        <div className="text-left py-8  ">
          
          <p className=" font-medium text-5xl uppercase  text-white  sm:tracking-tight lg:text-2xl">
            OUR MISSION
          </p>
      ...
      <div className="w-full flex bg-green-500 overflow-hidden">
        ...
        <div className="-mx-px border-l bg-green-500 border-gray-200 grid grid-cols-1 sm:grid-cols-2 sm:mx-0 ">
          ...
          <h1 className="text-white p-8 pb-48 text-3xl">Democratising access to investment opportunities.</h1>
        </div>
      </div>
